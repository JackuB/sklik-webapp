  ...
  $kampane = volej("listCampaigns");
    if(is_array($kampane)) {
      if(count($kampane["campaigns"]) > 0) {
        ...
        echo "<center><h2>Nemáte nastavené žádné kampanì</h2>Kampanì musíte nejdøíve vytvoøir na <a target=\"_blank\" href=\"http://sklik.cz\">Sklik.cz</a></center>";
      }
    } else {
      echo "Server pøi výpisu kampaní neodpovìdìl polem";
      print_r($kampane);
    }
